...
M.gameConfig = {
    --["gameid"]="hlddz2021",
    ["debug_console_port"]=18000,
    ["logind_port"]=18001,
    ["gates"]={
        ["gate_port_num"]=1,
        ["gate_port1"]=18011,
    },
    ["http_server_port"]=18008,
    ["http_server2_port"]=18009,
    httpClientPort = 18010,
    ["pub_server_url"]="http:47.105.195.185:11008",
    ["apple_err_url"]="http://game.jytx123.cn",

    ["http_server_ali_port"]=18012,
    ["http_server_third_plat"]=18013,
    ["hs_center_port"]=18014,
    ["hs_apple_port"]=18015,
    ["hs_data_collector_port"]=18017,
    ...
    ["agents"]={
        ["agent_num"]=1,
        ["agent_ip1"]="0.0.0.0:18001",
    },
    ["node"]="main",
    ["main_node_host"]="127.0.0.1",

    dbConnectNum = 16,--mgr中的db连接数
    ["dbs"]={
        ["main"]={
            {
                ["name"]="ddz_main",
...
--db.auth('ddz_main', 'XxbT458ezbSLPDfm')
return M